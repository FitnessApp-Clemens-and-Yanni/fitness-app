import {MealEntry, NUTRITIONAL_VALUE_OF_DAY_COLLECTION, NutritionalValueOfDay} from "@/data/meta/models";
...
export async function calculateNewNutritionalValuesInDatabase(
    ...
    const collection = db.collection<NutritionalValueOfDay>(NUTRITIONAL_VALUE_OF_DAY_COLLECTION);
